...
def load_config(path: str = "config.yaml") -> Settings:
    ...
    return Settings(
        ...
        wazuh_sca_index_pattern=cfg.get("WAZUH_SCA_INDEX_PATTERN", "wazuh-enrich-sca-results-latest"),
...
def _normalize_ubuntu_oval(raw: dict[str, Any]) -> dict[str, Any]:
    ...
    cfg["osv_include_binary_packages"] = _as_bool(cfg.get("osv_include_binary_packages", True))
